...
| MC-D07 | `CATALYST_STRENGTH` without components | Single scalar hides surprise/novelty | `cross_lane/evidence.py` | Over-trust | Expose component evidence objects | market_context contracts | Market Context | MC7 | P1 — **PARTIAL (IMP fixture scope: component metadata via MC7 cross-lane)** |
