...
│
└── Market Context MC1–MC16 [MC1–MC15 IMPLEMENTED (fixture); MC16 DESIGN COMPLETE]
```
...
| Market Context | MC1–MC15 | MC16 multi-document synthesis (design complete; implementation next) |
