...
OPTIONS O2 — IV + surface                       [NOT STARTED]
SHARED P2 — physical distribution P             [NOT STARTED]
...
OPTIONS O3–O4 — Q and P vs Q                    [NOT STARTED]
SHARED P3 — cross-lane fusion                   [PARTIAL]
FUTURES F6 — asset-family models                [NOT STARTED]
FUTURES F7 — macro / fundamental events           [NOT STARTED]
OPTIONS O5–O7 — flow, dealer, event vol         [NOT STARTED]
FUTURES F8 — leverage / liquidation stress        [NOT STARTED]
SHORT SQUEEZE SS P4–P5 — confirmation, fuel     [PLANNED]
FUTURES F9 — relative value spreads               [NOT STARTED]
OPTIONS O8 — strategy optimizer                 [NOT STARTED]
SHARED P4 — EV layer                            [RESEARCH]
FUTURES F10 — simulator extensions                [NOT STARTED]
OPTIONS O9 — options simulator                  [NOT STARTED]
SHORT SQUEEZE SS P6 — exhaustion                [PLANNED]
FUTURES F11 — advanced models                     [FUTURE]
OPTIONS O10–O11                                 [FUTURE]
