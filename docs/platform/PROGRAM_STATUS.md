...
| Cross-Asset | `PARTIAL` | XA-01 canonical identity kernel, XA-02 first admitted FRED rates reference vertical, temporal/provenance/quality contracts, and bounded macro, futures, energy, options, and participant foundations | Cross-asset analytics, relationship intelligence engines, and additional admitted reference verticals beyond the first rates slice | `IMP-XA-03` |
