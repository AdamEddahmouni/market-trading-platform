"""Phase 5R research/model infrastructure assertion registry and evaluator."""
...
MANDATORY_IDS = ("DATASET-001", "MODEL-001", "PIT-WF-001", "FCAST-001", "DET-001", "SAFE-003")

_ROLES = {
    "DATASET-001": (["ARCHITECTURE_LEAD"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER"]),
    "MODEL-001": (["ARCHITECTURE_LEAD"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER"]),
    "PIT-WF-001": (["ARCHITECTURE_LEAD"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER"]),
    "FCAST-001": (["ARCHITECTURE_LEAD"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER"]),
    "DET-001": (["ARCHITECTURE_LEAD"], ["RELEASE_OWNER"], ["INDEPENDENT_REVIEWER"]),
...
def build_registry(path: Path) -> dict[str, object]:
    ...
    if not isinstance(raw, dict) or raw.get("registry_version") != "1.0.0":
        raise ValueError("unsupported phase5r assertion registry")
