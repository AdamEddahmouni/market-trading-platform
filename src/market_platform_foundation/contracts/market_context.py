...
class ContextQualityFlag(StrEnum):
    ...
    ENTITY_LINK_AMBIGUOUS = "ENTITY_LINK_AMBIGUOUS"
    PROPAGATION_SOURCE_UNAVAILABLE = "PROPAGATION_SOURCE_UNAVAILABLE"
    PROPAGATION_LINK_STALE = "PROPAGATION_LINK_STALE"
    CROSS_ENTITY_PROPAGATION_EXPERIMENTAL = "CROSS_ENTITY_PROPAGATION_EXPERIMENTAL"
    SYNTHESIS_INSUFFICIENT_DOCS = "SYNTHESIS_INSUFFICIENT_DOCS"
    SYNTHESIS_REVISION_CONFLICT = "SYNTHESIS_REVISION_CONFLICT"
