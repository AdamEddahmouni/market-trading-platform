...
class LiveAuthorizationState(StrEnum):
    ...
    ENABLED = "ENABLED"
    # BUILD 29 canary lifecycle states.
    PREPARED = "PREPARED"
...
class LiveGateReasonCode(StrEnum):
    ...
    CANARY_AUTHORIZATION_NOT_AUTHORIZED = "CANARY_AUTHORIZATION_NOT_AUTHORIZED"
    CANARY_ORDER_CONFIRMATION_MISSING = "CANARY_ORDER_CONFIRMATION_MISSING"
    CANARY_ORDER_CONFIRMATION_EXPIRED = "CANARY_ORDER_CONFIRMATION_EXPIRED"
    CANARY_ORDER_CONFIRMATION_MISMATCH = "CANARY_ORDER_CONFIRMATION_MISMATCH"
    CANARY_POLICY_VIOLATION = "CANARY_POLICY_VIOLATION"
    CANARY_NOTIONAL_CAP_EXCEEDED = "CANARY_NOTIONAL_CAP_EXCEEDED"
    CANARY_ORDER_COUNT_EXCEEDED = "CANARY_ORDER_COUNT_EXCEEDED"
    CANARY_MARGIN_NOT_ALLOWED = "CANARY_MARGIN_NOT_ALLOWED"
    CANARY_SHORT_NOT_ALLOWED = "CANARY_SHORT_NOT_ALLOWED"
    CANARY_DERIVATIVE_NOT_ALLOWED = "CANARY_DERIVATIVE_NOT_ALLOWED"
    CANARY_OUTSIDE_RTH_NOT_ALLOWED = "CANARY_OUTSIDE_RTH_NOT_ALLOWED"
    CANARY_FLAT_START_VIOLATION = "CANARY_FLAT_START_VIOLATION"
    CANARY_AUTHORIZATION_CONSUMED = "CANARY_AUTHORIZATION_CONSUMED"
    CANARY_AUTHORIZATION_REVOKED = "CANARY_AUTHORIZATION_REVOKED"
    AMBIGUOUS_SUBMISSION_BLOCK = "AMBIGUOUS_SUBMISSION_BLOCK"
    UNEXPECTED_FILL_BLOCK = "UNEXPECTED_FILL_BLOCK"
    EXTERNAL_BROKER_ACTIVITY = "EXTERNAL_BROKER_ACTIVITY"
    PROGRAM_CAP_EXCEEDED = "PROGRAM_CAP_EXCEEDED"
    PROGRAM_SESSION_LIMIT = "PROGRAM_SESSION_LIMIT"
    PROGRAM_COOLDOWN_ACTIVE = "PROGRAM_COOLDOWN_ACTIVE"
    PROGRAM_HALTED = "PROGRAM_HALTED"
    PROGRAM_EXPIRED = "PROGRAM_EXPIRED"
    PROGRAM_RECONCILIATION_REQUIRED = "PROGRAM_RECONCILIATION_REQUIRED"
    SESSION_AUTHORIZATION_MISMATCH = "SESSION_AUTHORIZATION_MISMATCH"
    STALE_CONFIRMATION_AFTER_RESTART = "STALE_CONFIRMATION_AFTER_RESTART"
    ...
    OPERATIONAL_READINESS_UNKNOWN = "OPERATIONAL_READINESS_UNKNOWN"
    CRITICAL_HEARTBEAT_STALE = "CRITICAL_HEARTBEAT_STALE"
    RECOVERED_RUNTIME_BLOCKED = "RECOVERED_RUNTIME_BLOCKED"
