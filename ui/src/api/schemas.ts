...
export const WorkspaceMarketContextResponseSchema = z.object({
  ...
  expectations_available: z.boolean().optional(),
  ...
  materiality_evidence: z.array(z.record(z.string(), z.unknown())).optional(),
  credibility_evidence: z.array(z.record(z.string(), z.unknown())).optional(),
  impact_producer_id: z.string().optional(),
  impact_producer_version: z.string().optional(),
...
export const WorkspaceFuturesResponseSchema = z.object({
  ...
  latest_futures_forecast: z
    .object({
      futures_model_version: z.string().optional(),
      futures_model_version_number: z.string().optional(),
      baseline_tier: z.string().optional(),
      outright_up_probability: z.number().optional(),
      curve_steepen_probability: z.number().optional(),
      direction_bias: z.string().optional(),
      family: z.string().optional(),
      family_supported: z.boolean().optional(),
      futures_composite_score: z.number().optional(),
      futures_model_confidence: z.number().optional(),
      futures_quality_flags: z.array(z.string()).optional(),
      research_only: z.boolean().optional(),
      experimental: z.boolean().optional(),
    })
    .optional(),
  futures_advanced_forecast_available: z.boolean().optional(),
