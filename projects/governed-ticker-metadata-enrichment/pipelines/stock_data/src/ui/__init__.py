...
Backward compatibility:
    `from src.ui import LiveProgress, show_menu, watch_stats, ...` keeps
...
class LiveProgress:
    ...
    scrapers can `from src.ui import LiveProgress` without pulling in
...
# Quick demo if invoked directly: `python -m src.ui`.
