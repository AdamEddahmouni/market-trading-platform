"""Phase 9 provider and whale ledger assertion registry and evaluator."""
...
MANDATORY_IDS = ("P9-PROV-001", "P9-LEDGER-001", "P9-PIT-001", "P9-WHALE-001", "P9-UI-001", "SAFE-003")

_ROLES = {
    "P9-PROV-001": (["ARCHITECTURE_LEAD"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER"]),
    "P9-LEDGER-001": (["ARCHITECTURE_LEAD"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER"]),
    "P9-PIT-001": (["ARCHITECTURE_LEAD"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER"]),
    "P9-WHALE-001": (["ARCHITECTURE_LEAD"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER"]),
    "P9-UI-001": (["ARCHITECTURE_LEAD"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER"]),
...
def build_registry(path: Path) -> dict[str, object]:
    ...
    if not isinstance(raw, dict) or raw.get("registry_version") != "1.0.0":
        raise ValueError("unsupported phase9 assertion registry")
