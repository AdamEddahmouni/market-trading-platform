...
from src.operator_console._styles import COLOR_BRAND_PRIMARY, COLOR_RECORD, console
from src.operator_console.filter import FilterSpec, apply_filter, count_filter
...
def show_export_menu() -> Optional[ExportRequest]:
    ...
    if use_filter:
        from src.operator_console.filter import prompt_for_filters  # lazy import (cycle-safe)
