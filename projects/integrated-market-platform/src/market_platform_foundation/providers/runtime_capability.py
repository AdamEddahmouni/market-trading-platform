...
CAP_HISTORICAL_TRADES = "OBSERVATIONAL_HISTORICAL_TRADES"
...
_REGISTRY_CAPABILITY_ALIASES: dict[str, str] = {
    ...
    IBKR_CAPABILITY_HISTORICAL_TRADES: CAP_HISTORICAL_TRADES,
...
_LANE_TO_REGISTRY_CAPABILITIES: dict[str, tuple[str, ...]] = {
    ...
    CAP_HISTORICAL_TRADES: (IBKR_CAPABILITY_HISTORICAL_TRADES, "US_EQUITY_TICKS"),
