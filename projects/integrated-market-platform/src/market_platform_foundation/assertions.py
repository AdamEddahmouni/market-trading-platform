"""Exact Phase 0 assertion registry and coherent one-run evaluator."""
...
_ROLES = {
    "GOV-001": (["ARCHITECTURE_LEAD"], ["PROJECT_OWNER"], ["RELEASE_OWNER"]),
    "GOV-002": (["PROJECT_OWNER"], ["RELEASE_OWNER"], ["INDEPENDENT_REVIEWER"]),
    "GOV-003": (["PROJECT_OWNER", "RELEASE_OWNER"], ["PROJECT_OWNER", "RELEASE_OWNER"], ["ARCHITECTURE_LEAD", "PROTOTYPE_MAINTAINERS"]),
    "GOV-004": (["ARCHITECTURE_LEAD", "RELEASE_OWNER", "SECURITY_OWNER"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER", "REPLAY_OWNER"]),
    "SAFE-001": (["RELEASE_OWNER"], ["SECURITY_OWNER"], ["INDEPENDENT_REVIEWER"]),
    "SAFE-002": (["ARCHITECTURE_LEAD"], ["RELEASE_OWNER", "SECURITY_OWNER"], ["EXECUTION_OWNER", "INDEPENDENT_REVIEWER"]),
    "SAFE-003-STATIC": (["REPLAY_OWNER", "SECURITY_OWNER"], ["RELEASE_OWNER"], ["ARCHITECTURE_LEAD", "EXECUTION_OWNER", "INDEPENDENT_REVIEWER"]),
    "SAFE-P0-001": (["REPLAY_OWNER", "SECURITY_OWNER"], ["RELEASE_OWNER"], ["ARCHITECTURE_LEAD", "EXECUTION_OWNER", "INDEPENDENT_REVIEWER"]),
    "SEC-001": (["SECURITY_OWNER"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER", "RELEASE_OWNER"]),
}
...
def build_registry(path: Path) -> dict[str, object]:
    ...
    if not isinstance(raw, dict) or raw.get("registry_version") != "1.0.0":
        raise ValueError("unsupported assertion registry")
