...
def run_historical_development_simulator_research(
    ...
    *,
    ...
    return {
        ...
        "max_drawdown": execution.get("max_drawdown"),
        "max_drawdown_source": execution.get("max_drawdown_source"),
        "drawdown_metrics_version": execution.get("drawdown_metrics_version"),
        "equity_curve_point_count": execution.get("equity_curve_point_count"),
