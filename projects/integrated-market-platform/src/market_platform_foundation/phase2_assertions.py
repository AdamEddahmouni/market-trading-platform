"""Phase 2 contract and replay assertion registry and evaluator."""
...
MANDATORY_IDS = ("TC-001", "TC-002", "TC-003", "DET-001")

_ROLES = {
    assertion_id: (["ARCHITECTURE_LEAD"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER"])
...
def build_registry(path: Path) -> dict[str, object]:
    ...
    if not isinstance(raw, dict) or raw.get("registry_version") != "1.0.0":
        raise ValueError("unsupported phase2 assertion registry")
