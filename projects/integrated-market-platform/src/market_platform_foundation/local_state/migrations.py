...
MIGRATIONS: dict[int, tuple[str, ...]] = {
    ...
    7: ENRICHMENT_OUTBOX_V7,
    8: TRADE_REVIEW_V8,
    9: INTELLIGENCE_BOOK_V9,
    10: WORKSPACE_INVESTIGATIONS_V10,
    11: WORKSPACE_INVESTIGATIONS_V11,
}
