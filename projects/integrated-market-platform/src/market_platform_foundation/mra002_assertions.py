"""MRA-002 Anthropic assistant acceptance assertion registry and evaluator."""
...
MANDATORY_IDS = ("MRA2-001", "MRA2-002", "MRA2-003", "MRA2-004", "MRA2-005")

_ROLES = {
    "MRA2-001": (["ARCHITECTURE_LEAD"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER"]),
    "MRA2-002": (["ARCHITECTURE_LEAD"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER"]),
    "MRA2-003": (["ARCHITECTURE_LEAD"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER"]),
    "MRA2-004": (["RELEASE_OWNER"], ["SECURITY_OWNER"], ["INDEPENDENT_REVIEWER"]),
    "MRA2-005": (["ARCHITECTURE_LEAD"], ["PROJECT_OWNER"], ["INDEPENDENT_REVIEWER"]),
}
...
def build_registry(path: Path) -> dict[str, object]:
    ...
    if not isinstance(raw, dict) or raw.get("registry_version") != "1.0.0":
        raise ValueError("unsupported mra002 assertion registry")
