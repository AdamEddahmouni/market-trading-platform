...
def instrument_record_from_dict(body: dict[str, Any]) -> InstrumentRecord:
    ...
    descriptor = InstrumentDescriptor(
        ...
        tradability=Tradability(str(body.get("tradability", Tradability.REFERENCE_ONLY.value))),
        sovereign_issuer=str(body.get("sovereign_issuer", "")),
        issuer=str(body.get("issuer", "")),
        security_type=str(body.get("security_type", "")),
        credit_tier=str(body.get("credit_tier", "")),
        par_value=str(body.get("par_value", "")),
        ...
        commodity_sector=str(body.get("commodity_sector", "")),
