...
STRATEGY_RUNTIME_PINETS_RESEARCH_READY = "STRATEGY_RUNTIME_PINETS_RESEARCH_READY"
STRATEGY_RUNTIME_PINETS_LICENSE_BOUNDARY = "STRATEGY_RUNTIME_PINETS_LICENSE_BOUNDARY"
