"""Pinned upstream Market Trackers contract (congressional PTR preparation only)."""
...
UPSTREAM_PIN = UpstreamPin(
    ...
    dataset_id="congress-trades",
    export_dir="congress/trades",
    schema_version=1,
    ...
    primary_source_authority=(
        "U.S. Senate eFD and U.S. House Clerk financial disclosures (STOCK Act PTR); "
        "Market Trackers is not primary"
    ),
)

ADAPTER_PREP_VERSION = "market_trackers.congressional_disclosure/0.1.0-prep"
