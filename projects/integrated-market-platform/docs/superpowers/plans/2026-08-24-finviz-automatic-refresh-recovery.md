...
- [x] **Step 1: Write failing redirect and login-flow tests**
...
- [x] **Step 3: Implement the current, injectable login flow**
...
- [x] **Step 4: Run focused login tests and changed validation**
...
- [x] **Step 5: Commit the login boundary**
...
- [x] **Step 1: Write failing reload tests**
...
- [x] **Step 3: Implement safe reload and adoption**
...
- [x] **Step 4: Run focused auth tests and changed validation**
...
- [x] **Step 5: Commit changed-token recovery**
...
- [x] **Step 1: Write failing backoff and cache tests**
...
- [x] **Step 3: Implement classified-response retry and caching**
...
- [x] **Step 4: Run request tests and changed validation**
...
- [x] **Step 5: Commit retry and cache behavior**
...
- [x] **Step 1: Write failing adapter-selection tests**
...
- [x] **Step 3: Implement tool-layer transport selection**
...
- [x] **Step 4: Document and run final offline verification**
...
- [x] **Step 5: Review and commit the completed recovery slice**
