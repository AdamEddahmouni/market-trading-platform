...
> **HISTORICAL_TRUTH.** Cutoff is the 2026-09-15 RTH observation. Later software
> on `main` (`#210`–`#218`) closed capture/persist wiring; governed corpus remains
> **0** and Item 7 stays **PARTIAL**. Do not rewrite this observation and do not
> treat this note as current architecture.
