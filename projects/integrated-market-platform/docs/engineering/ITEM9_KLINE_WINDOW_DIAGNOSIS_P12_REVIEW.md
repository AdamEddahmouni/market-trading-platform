...
> **HISTORICAL_TRUTH.** Sep 15 `PROSPECTIVE_NO_POST_SIGNAL_BAR` stands.
> Session-day kline software later reconstructed in `#203`. This review is
> not a calibration claim and must not be rewritten.
