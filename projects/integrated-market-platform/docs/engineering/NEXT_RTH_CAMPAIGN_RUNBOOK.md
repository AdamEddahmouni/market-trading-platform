...
| **FROZEN_RUNTIME** (alias **CANDIDATE_RUNTIME**) | `02d699768dce2ad2e85d7215f2588fd18a36fcce` | **Frozen, not armed** runtime for campaign `RTH-OBS-NEWS-20260924`. Tree `84d254547fa7e209b461c84ce172397f514bc4b9`. State **`FROZEN_NOT_ARMED`**. Contains [#403](https://github.com/AdamEddahmouni/market-trading-platform/pull/403) and [#404](https://github.com/AdamEddahmouni/market-trading-platform/pull/404). **Do not** move this SHA after arm. Operator procedure: [RTH_OBS_NEWS_20260924_FREEZE.md](RTH_OBS_NEWS_20260924_FREEZE.md). |
| **CURRENT_MAIN** (alias **CURRENT_GIT_MAIN**) | `2c40c51cc951c90418b3d6e13b86355ba7e884df` at the Sep 24 freeze (confirm with `git rev-parse origin/main`) | Git tip after [#404](https://github.com/AdamEddahmouni/market-trading-platform/pull/404). **Not** the Sep 24 runtime until that commit is an ancestor of `origin/main`. **Not** **ITEM9_FROZEN_COLLECTOR**. |
| **CURRENT_SOFTWARE_IMPLEMENTATION** | `02d699768dce2ad2e85d7215f2588fd18a36fcce` | Sep 24 frozen runtime. Software only. **Not** empirical evidence. Calibration **not** executed. Historical Smoke10 `ibp-smoke10-8C23029DD46FDA78` remains **FAIL 10/10** and was not rerun. |
...
**Next arm:** `RTH-OBS-NEWS-20260924` on frozen runtime `02d699768dce2ad2e85d7215f2588fd18a36fcce`. Session date `2026-09-24`, `09:30`–`16:00` America/New_York (`is_trading_day` true; `2026-09-07` is the holiday). State **`FROZEN_NOT_ARMED`**. The only launch procedure is [RTH_OBS_NEWS_20260924_FREEZE.md](RTH_OBS_NEWS_20260924_FREEZE.md). [#403](https://github.com/AdamEddahmouni/market-trading-platform/pull/403) is software inside that runtime. It is not Sep 23 proof and not `EMPIRICALLY_PROVEN`.
...
|---|-------|----------------|------------|
| 1 | Git SHA | Checkout **FROZEN_RUNTIME** `02d699768dce2ad2e85d7215f2588fd18a36fcce` (tree `84d254547fa7e209b461c84ce172397f514bc4b9`). Closed campaign runtime `bf405f46` stays read-only. | Exact SHA match. **Not** `bf405f46`. **Not** **ITEM9_FROZEN_COLLECTOR** `fed2d9f7`. |
