...
| **FROZEN_RUNTIME** (alias **CANDIDATE_RUNTIME**) | `c15527221a21d7bc88acefbe0971b6de9292247e` | **Frozen, not armed** runtime for campaign `RTH-OBS-NEWS-20260924`. Tree `e77f72208b6547d63dc4b7101c5cfa357114052b`. State **`FROZEN_NOT_ARMED`**. Contains [#403](https://github.com/AdamEddahmouni/market-trading-platform/pull/403) and [#404](https://github.com/AdamEddahmouni/market-trading-platform/pull/404). **Do not** move this SHA after arm. Operator procedure: [RTH_OBS_NEWS_20260924_FREEZE.md](RTH_OBS_NEWS_20260924_FREEZE.md). |
...
| **CURRENT_SOFTWARE_IMPLEMENTATION** | `c15527221a21d7bc88acefbe0971b6de9292247e` | Sep 24 frozen runtime. Software only. **Not** empirical evidence. Calibration **not** executed. Historical Smoke10 `ibp-smoke10-8C23029DD46FDA78` remains **FAIL 10/10** and was not rerun. |
...
|---|-------|----------------|------------|
| 1 | Git SHA | Checkout **FROZEN_RUNTIME** `c15527221a21d7bc88acefbe0971b6de9292247e` (tree `e77f72208b6547d63dc4b7101c5cfa357114052b`). Closed campaign runtime `bf405f46` stays read-only. | Exact SHA match. **Not** `bf405f46`. **Not** **ITEM9_FROZEN_COLLECTOR** `fed2d9f7`. |
