...
| Label | Git SHA | Role |
|-------|---------|------|
| **FROZEN_RUNTIME** (alias **CANDIDATE_RUNTIME**) | `bf405f468bee4e70f8a40e97eaaf6c2d46c75e64` | **Frozen observational runtime** for campaign `RTH-OBS-NEWS-20260923` / FTEP-V1-002. Runtime **tree** SHA `c3b5a08b94e93e4ead3c9802092ecdebea1c3434`. State **`FROZEN_NOT_ARMED`** (`frozen=yes`). Includes [#385](https://github.com/AdamEddahmouni/market-trading-platform/pull/385) campaign supervision + [#384](https://github.com/AdamEddahmouni/market-trading-platform/pull/384) benchmark protocol. **Do not** retarget this SHA to a later docs tip. **Do not** arm from this freeze alone. |
| **CURRENT_MAIN** (alias **CURRENT_GIT_MAIN**) | mutable `origin/main` tip (may be docs-only ahead of **FROZEN_RUNTIME**) | Git tip after fetch. After [#386](https://github.com/AdamEddahmouni/market-trading-platform/pull/386) docs tip may be `fd19258d…` or later. **Docs tip ≠ runtime.** Arm/checkout uses **FROZEN_RUNTIME** `bf405f46…`, not a docs commit. **Not** **ITEM9_FROZEN_COLLECTOR**. |
| **CURRENT_SOFTWARE_IMPLEMENTATION** | `bf405f468bee4e70f8a40e97eaaf6c2d46c75e64` | Same tree as **FROZEN_RUNTIME**. Includes fail-closed campaign supervision ([#385](https://github.com/AdamEddahmouni/market-trading-platform/pull/385); ancestry [#381](https://github.com/AdamEddahmouni/market-trading-platform/pull/381)/[#380](https://github.com/AdamEddahmouni/market-trading-platform/pull/380)/[#379](https://github.com/AdamEddahmouni/market-trading-platform/pull/379)) plus merged benchmark protocol / deterministic-stub Smoke10 pin ([#384](https://github.com/AdamEddahmouni/market-trading-platform/pull/384)). **Not** empirical evidence. Calibration **not** executed. Real-system RTH15-11 Smoke10 remains **NOT_EXECUTED**. |
...
**Next observational campaign freeze (2026-09-22 night, America/New_York):** Campaign identity `RTH-OBS-NEWS-20260923` / FTEP-V1-002 is **`FROZEN_NOT_ARMED`**. Runtime commit **`bf405f468bee4e70f8a40e97eaaf6c2d46c75e64`** (tree `c3b5a08b94e93e4ead3c9802092ecdebea1c3434`). Freeze timestamp **`2026-09-22T23:46:17-04:00`** (`2026-09-23T03:46:17Z`). Freeze does **not** mean EMPIRICAL_ACTIVE, provider checks passed, Item 7 corpus, Item 9 bar, or calibration. **Never ARMED_RUNNING** from this freeze. Arm requires a separate operator act after unpaid operator-at-arm PARTIALS are resolved.
...
| Concern | Binding on **FROZEN_RUNTIME** `bf405f46` (`FROZEN_NOT_ARMED`) |
|---------|-----------------------------------------------|
...
Run from IMP root `projects/integrated-market-platform/` on the **frozen runtime** checkout (not a dirty detached workspace). **FROZEN_RUNTIME** is `bf405f468bee4e70f8a40e97eaaf6c2d46c75e64` with **`FROZEN_NOT_ARMED`** (`frozen=yes`). **Do not arm** until unpaid operator-at-arm PARTIALS are resolved and the operator explicitly arms.

| # | Check | Command / path | Pass token |
|---|-------|----------------|------------|
| 1 | Git SHA | Checkout **FROZEN_RUNTIME** `bf405f468bee4e70f8a40e97eaaf6c2d46c75e64` (tree `c3b5a08b…`). Docs tip may differ. | Exact frozen runtime SHA. **`FROZEN_NOT_ARMED`**. **Not** **ITEM9_FROZEN_COLLECTOR** `fed2d9f7`. |
