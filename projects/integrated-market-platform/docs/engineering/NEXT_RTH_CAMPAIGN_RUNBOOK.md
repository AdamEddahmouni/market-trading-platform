...
| Label | Git SHA | Role |
|-------|---------|------|
| **CURRENT_MAIN** (alias **CURRENT_GIT_MAIN** in [PROGRAM_STATUS](../platform/PROGRAM_STATUS.md)) | `a6e4f9a5725edbdf7ad503cd6c4f110b014cb7c9` | Mutable `origin/main` tip after [#357](https://github.com/AdamEddahmouni/market-trading-platform/pull/357) docs pin. Confirm with `git rev-parse origin/main` after `git fetch origin main`. Docs-only pins may advance this SHA without moving **CURRENT_SOFTWARE_IMPLEMENTATION**. **Not** **ITEM9_FROZEN_COLLECTOR**. |
| **CURRENT_SOFTWARE_IMPLEMENTATION** | `9df351d8091f8b023b90f875d4e1c4642ab52d2a` | Last **software-bearing** merge [#358](https://github.com/AdamEddahmouni/market-trading-platform/pull/358) UNAVAILABLE eligibility workspace/ack gate (includes [#356](https://github.com/AdamEddahmouni/market-trading-platform/pull/356)–[#353](https://github.com/AdamEddahmouni/market-trading-platform/pull/353)). **Not** empirical evidence. |
