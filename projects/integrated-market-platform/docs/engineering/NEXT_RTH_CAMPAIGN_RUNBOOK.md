...
| Label | Git SHA | Role |
|-------|---------|------|
| **FROZEN_RUNTIME** (alias **CANDIDATE_RUNTIME**) | `bf405f468bee4e70f8a40e97eaaf6c2d46c75e64` | **Closed** observational runtime for campaign `RTH-OBS-NEWS-20260923`. Runtime **tree** SHA `c3b5a08b94e93e4ead3c9802092ecdebea1c3434`. Terminal class **`PARTIAL_LATE_ARM`**. **Do not** retarget this SHA. **Do not** re-arm it. |
| **CURRENT_MAIN** (alias **CURRENT_GIT_MAIN**) | `4fcec08b65e596f630ebf7e209924d7a7bb50751` at this closeout (confirm with `git rev-parse origin/main`) | Git tip after fetch. Includes [#402](https://github.com/AdamEddahmouni/market-trading-platform/pull/402) and [#403](https://github.com/AdamEddahmouni/market-trading-platform/pull/403). **Not** the Sep 23 runtime. **Not** **ITEM9_FROZEN_COLLECTOR**. |
| **CURRENT_SOFTWARE_IMPLEMENTATION** | `4fcec08b65e596f630ebf7e209924d7a7bb50751` | Same commit as **CURRENT_MAIN** at this closeout. [#403](https://github.com/AdamEddahmouni/market-trading-platform/pull/403) durability is software. The next arm needs a **new** frozen runtime cut from this line, not `bf405f46`. **Not** empirical evidence. Calibration **not** executed. Historical Smoke10 `ibp-smoke10-8C23029DD46FDA78` remains **FAIL 10/10** and was not rerun. |
...
**Next arm:** a new campaign id on a new frozen runtime that contains [#403](https://github.com/AdamEddahmouni/market-trading-platform/pull/403) (`8232b155` on `origin/main` `4fcec08b`). [#403](https://github.com/AdamEddahmouni/market-trading-platform/pull/403) is software. It still requires a prospective RTH proof. Current software tip is [PROGRAM_STATUS.md](../platform/PROGRAM_STATUS.md), not `bf405f46`.
...
`RTH-OBS-NEWS-20260923` on `bf405f468bee4e70f8a40e97eaaf6c2d46c75e64` is **closed**. Run the next campaign from a **new** frozen checkout cut after [#403](https://github.com/AdamEddahmouni/market-trading-platform/pull/403), from IMP root `projects/integrated-market-platform/` (not a dirty detached workspace). **Do not arm** until the closeout prerequisites in [RTH_OBS_NEWS_20260923_CLOSEOUT.md](RTH_OBS_NEWS_20260923_CLOSEOUT.md) are true and the operator explicitly arms a new campaign id.

| # | Check | Command / path | Pass token |
|---|-------|----------------|------------|
| 1 | Git SHA | New frozen runtime cut from current `origin/main` after [#403](https://github.com/AdamEddahmouni/market-trading-platform/pull/403). Closed campaign runtime `bf405f46` stays read-only. | Exact new runtime SHA recorded before arm. **Not** `bf405f46`. **Not** **ITEM9_FROZEN_COLLECTOR** `fed2d9f7`. |
