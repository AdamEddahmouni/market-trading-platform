...
Machine-readable source of truth: [`formula_ledger.json`](formula_ledger.json) (`formula_ledger_v1`, 2026-09-05, 88 rows).
...
| Options IV/Greeks/Q/P−Q | BSM, Newton IV, greeks day-count, Q `risk_neutral_log_normal_moment_approx_v1` (not Breeden–Litzenberger), friction fail-closed without underlying price, O10/R-O6 fail-closed without rate |
...
1. Q version is `risk_neutral_log_normal_moment_approx_v1` (not Breeden–Litzenberger)
