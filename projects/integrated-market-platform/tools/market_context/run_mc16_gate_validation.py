"""Run MC16 multi-document synthesis gate validation on admitted BOXL fixtures."""
...
DEFAULT_OUTPUT = ROOT / "evidence/market_context/mc16-gate-validation-report.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="MC16 multi-document synthesis gate report")
    parser.add_argument(
        "--output",
...
def main() -> int:
    ...
    if args.dry_run:
        summary = {
            ...
            "synthesis_count": report.get("synthesis_count"),
