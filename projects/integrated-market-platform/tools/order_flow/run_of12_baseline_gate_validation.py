"""Run OF12-S1 baseline gate validation on admitted ES fixtures."""
...
DEFAULT_OUTPUT = ROOT / "evidence/order_flow/baseline-gate-validation-report.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="OF12-S1 baseline gate validation report")
    parser.add_argument(
        "--output",
