...
def publish(*, publication_path: Path, build_run_dir: Path) -> dict[str, object]:
    ...
    final_doc = {
        "artifact_type": "MRA001_FINAL_ACCEPTANCE_RESULT",
        ...
        "logical_id": "mra001.final_acceptance_result",
        "outcome": "PASS",
        "run_id": run_id,
    }
    write_canonical_json(POSTREVIEW_DIR / "mra001.final_acceptance_result.json", final_doc)
    ...
    publication_doc = {
        ...
        "effect": (
            ...
            "(deterministic explain/inspect retrieval; no LLM)."
        ),
        "final_acceptance_result": {
            "final_result_id": final_doc["final_result_id"],
            "outcome": "PASS",
            "repository_relative_path": "evidence/mra001/postreview-pass/mra001.final_acceptance_result.json",
            "sha256": sha256_bytes((POSTREVIEW_DIR / "mra001.final_acceptance_result.json").read_bytes()),
        },
        "logical_id": "mra001.pass_publication",
        "principal_id": "PROJECT-PRINCIPAL-001",
        "published_at": "2026-08-18T17:00:00.000000000Z",
        "publisher_capacities": ["PROJECT_OWNER", "RELEASE_OWNER"],
        "repository_root_id": "ROOT-2E7C91F4",
        "schema_version": "1.0.0",
        "status": "PUBLISHED",
        "summary": "MRA-001 assertions MRA-001 through MRA-005 pass on admitted fixture.",
    }
