...
# Keep aligned with formulas / squeeze_models source+test globs in
# tools/validation_manifest.json. Those suites import the admitted sibling
# short-squeeze-core checkout that CI sparse-clones.
