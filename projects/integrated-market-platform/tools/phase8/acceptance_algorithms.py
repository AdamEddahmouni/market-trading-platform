"""Phase 8 postreview acceptance index algorithms."""
...
PHASE8_POSTREVIEW_INDEX_IDS = frozenset(
    {
        "phase8.ai_review_coverage",
        "phase8.ai_review_runs",
        "phase8.approval_records",
...
def expected_index_logical_ids(candidate_ids: list[str]) -> tuple[str, ...]:
    ...
    return tuple(sorted(set(candidate_ids) | PHASE8_POSTREVIEW_INDEX_IDS))
