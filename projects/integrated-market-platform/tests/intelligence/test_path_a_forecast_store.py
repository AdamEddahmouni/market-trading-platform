...
class PathAForecastLoadHopTests(unittest.TestCase):
    ...
    def test_prospective_and_cli_never_mint_probability(self) -> None:
        ...
        self.assertIn("contributor_path", prospective)
        self.assertIn("calibration_path", prospective)
        self.assertIn("produce_paper_demo_forecast", prospective)
        self.assertIn("--forecast-path", cli)
        self.assertIn("--contributor-path", cli)
        self.assertIn("--calibration-path", cli)
        self.assertNotIn("--probability", cli)
        self.assertNotIn("probability=0.8", cli)
        self.assertIn("produce_paper_demo_forecast", cli)
