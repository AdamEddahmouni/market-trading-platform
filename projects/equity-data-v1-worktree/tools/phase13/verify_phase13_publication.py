"""Verify Phase 13 PASS publication."""
...
def verify() -> list[str]:
    ...
    if manifest.get("phase13_status") != "PASS":
        reasons.append("AUTHORITY_PHASE13_NOT_PASS")
    ...
    for name in (
        "phase13.acceptance_index.json",
        "phase13.final_acceptance_result.json",
    ):
...
def main() -> int:
    ...
    if reasons:
        ...
        return 1
    print("phase13.pass_publication VERIFIED")
    return 0
