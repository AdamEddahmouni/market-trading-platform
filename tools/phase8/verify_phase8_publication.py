"""Verify published Phase 8 PASS bindings."""
...
FINAL_RESULT_PATH = ROOT / "evidence/phase8/postreview-pass/phase8.final_acceptance_result.json"
INDEX_PATH = ROOT / "evidence/phase8/postreview-pass/phase8.acceptance_index.json"
...
def main() -> int:
    all_ok = True
    print("=== Phase 8 publication verification ===")
    ...
    if not isinstance(manifest, dict):
        ...
        if phase8_status != "PASS":
            all_ok = False
            print(f" FAIL authority.phase8_status: {phase8_status}")
        else:
            print(" PASS authority.phase8_status: PASS")
