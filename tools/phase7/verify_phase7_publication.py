"""Verify published Phase 7 PASS bindings."""
...
FINAL_RESULT_PATH = ROOT / "evidence/phase7/postreview-pass/phase7.final_acceptance_result.json"
INDEX_PATH = ROOT / "evidence/phase7/postreview-pass/phase7.acceptance_index.json"
...
def main() -> int:
    all_ok = True
    print("=== Phase 7 publication verification ===")
    ...
    if not isinstance(manifest, dict):
        ...
        if phase7_status != "PASS":
            all_ok = False
            print(f" FAIL authority.phase7_status: {phase7_status}")
        else:
            print(" PASS authority.phase7_status: PASS")
