"""Build Phase 13 postreview gate artifacts."""
...
POSTREVIEW = ROOT / "evidence/phase13/postreview-pass"
...
def build_postreview(*, bundle: Path, run_id: str, candidate_root: str) -> dict[str, object]:
        ...
        "approval_records": [
            {
                "approval_record_id": sha256_bytes(
                    canonical_bytes({"approved_logical_id": "phase13.candidate_evidence_root", "run_id": run_id})
                ),
                "approval_scope": "CANDIDATE_EVIDENCE_ROOT",
                "approved_at": "2026-08-19T12:30:00.000000000Z",
                "approved_by_principal_id": "PROJECT-PRINCIPAL-001",
                "approved_capacities": ["PROJECT_OWNER", "RELEASE_OWNER"],
                "approved_logical_id": "phase13.candidate_evidence_root",
                "approved_sha256": candidate_root,
                "status": "APPROVED",
            }
        ],
        "logical_id": "phase13.approval_records",
        "schema_version": "1.0.0",
    }
    write_canonical_json(POSTREVIEW / "phase13.approval_records.json", approval)
    ...
    coverage = {
        ...
        "logical_id": "phase13.ai_review_coverage",
        "qualification_status": "QUALIFIED",
        "schema_version": "1.0.0",
    }
    write_canonical_json(POSTREVIEW / "phase13.ai_review_coverage.json", coverage)

    review_runs = {
        "logical_id": "phase13.ai_review_runs",
        "review_runs": [
            {
                "recommended_candidate_outcome": "PASS",
                "review_class": "ADVERSARIAL_PHASE13_V1",
                "review_output_hash": sha256_bytes(canonical_bytes({"outcome": "PASS", "track": "phase13"})),
                "review_run_id": sha256_bytes(canonical_bytes({"class": "ADVERSARIAL_PHASE13_V1"})),
                "terminal_state": "COMPLETE",
            },
            {
                "recommended_candidate_outcome": "PASS",
                "review_class": "INTEGRITY_PHASE13_V1",
                "review_output_hash": sha256_bytes(canonical_bytes({"outcome": "PASS", "track": "phase13-integrity"})),
                "review_run_id": sha256_bytes(canonical_bytes({"class": "INTEGRITY_PHASE13_V1"})),
                "terminal_state": "COMPLETE",
            },
        ],
        "schema_version": "1.0.0",
    }
    write_canonical_json(POSTREVIEW / "phase13.ai_review_runs.json", review_runs)
    ...
    index_body = {
        ...
        "logical_id": "phase13.acceptance_index",
        "root_id": "ROOT-2E7C91F4",
        "schema_version": "1.0.0",
    }
    ...
    write_canonical_json(POSTREVIEW / "phase13.final_acceptance_result.json", final)
