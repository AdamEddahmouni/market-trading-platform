...
POSTREVIEW = ROOT / "evidence/phase10/postreview-pass"
...
def build_postreview(*, bundle: Path, run_id: str, candidate_root: str) -> dict[str, object]:
        ...
        "approval_records": [
            {
                "approval_record_id": sha256_bytes(
                    canonical_bytes({"approved_logical_id": "phase10.candidate_evidence_root", "run_id": run_id})
                ),
                ...
                "approved_logical_id": "phase10.candidate_evidence_root",
                "approved_sha256": candidate_root,
                "status": "APPROVED",
            }
        ],
        "logical_id": "phase10.approval_records",
        "schema_version": "1.0.0",
    }
    write_canonical_json(POSTREVIEW / "phase10.approval_records.json", approval)
    ...
    coverage = {
        ...
        "logical_id": "phase10.ai_review_coverage",
        "qualification_status": "QUALIFIED",
        "schema_version": "1.0.0",
    }
    write_canonical_json(POSTREVIEW / "phase10.ai_review_coverage.json", coverage)

    review_runs = {
        "logical_id": "phase10.ai_review_runs",
        "review_runs": [
            {
                "recommended_candidate_outcome": "PASS",
                "review_class": "ADVERSARIAL_PHASE10_V1",
                "review_output_hash": sha256_bytes(canonical_bytes({"outcome": "PASS", "track": "phase10"})),
            ...
            },
            {
                ...
                "review_output_hash": sha256_bytes(canonical_bytes({"outcome": "PASS", "track": "phase10-integrity"})),
    ...
    write_canonical_json(POSTREVIEW / "phase10.ai_review_runs.json", review_runs)
    ...
    index_body = {
        ...
        "logical_id": "phase10.acceptance_index",
        "root_id": "ROOT-2E7C91F4",
        "schema_version": "1.0.0",
    }
    ...
    write_canonical_json(POSTREVIEW / "phase10.final_acceptance_result.json", final)
