"""Verify published Phase 6 PASS bindings."""
...
FINAL_RESULT_PATH = ROOT / "evidence/phase6/postreview-pass/phase6.final_acceptance_result.json"
INDEX_PATH = ROOT / "evidence/phase6/postreview-pass/phase6.acceptance_index.json"
...
def main() -> int:
    ...
    if not isinstance(manifest, dict):
        ...
        if phase6_status != "PASS":
            all_ok = False
            print(f" FAIL authority.phase6_status: {phase6_status}")
        else:
            print(" PASS authority.phase6_status: PASS")
