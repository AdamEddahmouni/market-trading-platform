"""Verify published Phase 2 PASS bindings."""
...
FINAL_RESULT_PATH = ROOT / "evidence/phase2/postreview-pass/phase2.final_acceptance_result.json"
INDEX_PATH = ROOT / "evidence/phase2/postreview-pass/phase2.acceptance_index.json"
...
def main() -> int:
    all_ok = True
    print("=== Phase 2 publication verification ===")
    ...
    if not isinstance(manifest, dict):
        ...
        if phase2_status != "PASS":
            all_ok = False
            print(f" FAIL authority.phase2_status: {phase2_status}")
        else:
            print(" PASS authority.phase2_status: PASS")
    ...
    if not PUBLICATION_PATH.is_file():
        ...
        if not isinstance(publication, dict) or publication.get("status") != "PUBLISHED":
            ...
            if isinstance(bound, dict):
                ...
                if phase3_status:
                    print(f" NOTE manifest extended with phase3_status={phase3_status}")
