...
POSTREVIEW = ROOT / "evidence/phase15/postreview-pass"
...
def build_postreview(*, bundle: Path, run_id: str, candidate_root: str) -> dict[str, object]:
        ...
        "approval_records": [
            {
                "approval_record_id": sha256_bytes(
                    canonical_bytes({"approved_logical_id": "phase15.candidate_evidence_root", "run_id": run_id})
                ),
                ...
                "approved_logical_id": "phase15.candidate_evidence_root",
                "approved_sha256": candidate_root,
                "status": "APPROVED",
            }
        ],
        "logical_id": "phase15.approval_records",
        "schema_version": "1.0.0",
    }
    write_canonical_json(POSTREVIEW / "phase15.approval_records.json", approval)
    ...
    coverage = {
        ...
        "logical_id": "phase15.ai_review_coverage",
        "qualification_status": "QUALIFIED",
        "schema_version": "1.0.0",
    }
    write_canonical_json(POSTREVIEW / "phase15.ai_review_coverage.json", coverage)

    review_runs = {
        "logical_id": "phase15.ai_review_runs",
        "review_runs": [
            {
                "recommended_candidate_outcome": "PASS",
                "review_class": "ADVERSARIAL_phase15_V1",
                "review_output_hash": sha256_bytes(canonical_bytes({"outcome": "PASS", "track": "phase15"})),
                "review_run_id": sha256_bytes(canonical_bytes({"class": "ADVERSARIAL_phase15_V1"})),
                "terminal_state": "COMPLETE",
            },
            {
                "recommended_candidate_outcome": "PASS",
                "review_class": "INTEGRITY_phase15_V1",
                "review_output_hash": sha256_bytes(canonical_bytes({"outcome": "PASS", "track": "phase15-integrity"})),
                "review_run_id": sha256_bytes(canonical_bytes({"class": "INTEGRITY_phase15_V1"})),
                "terminal_state": "COMPLETE",
            },
        ],
        "schema_version": "1.0.0",
    }
    write_canonical_json(POSTREVIEW / "phase15.ai_review_runs.json", review_runs)
    ...
    write_canonical_json(POSTREVIEW / "phase15.acceptance_index.json", index)
    ...
    final = {
        ...
        "logical_id": "phase15.final_acceptance_result",
        "outcome": "PASS",
        "reason_codes": [],
    ...
    write_canonical_json(POSTREVIEW / "phase15.final_acceptance_result.json", final)
