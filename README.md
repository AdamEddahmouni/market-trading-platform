...
operations, and user-surface work built on it. The exact-hash Foundation
binding remains [`canonical-authority.json`](manifests/phase0/canonical-authority.json).
